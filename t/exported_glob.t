...
# When FastGlob is loaded and glob() is called without & or package qualifier,
# the result must not contain any spurious extra values (e.g. a trailing 0).
# On Perl 5.16, the ($) prototype caused the built-in glob iterator to append
# a false/0 value after the real results.
